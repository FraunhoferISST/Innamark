...
import de.fraunhofer.isst.innamark.watermarker.types.watermarks.InnamarkTag.FailedInnamarkExtractionsWarning
import de.fraunhofer.isst.innamark.watermarker.types.watermarks.InnamarkTag.IncompleteTagError
import de.fraunhofer.isst.innamark.watermarker.types.watermarks.InnamarkTag.InvalidTagError
import de.fraunhofer.isst.innamark.watermarker.types.watermarks.InnamarkTagInterface.Companion.TAG_SIZE
import de.fraunhofer.isst.innamark.watermarker.utils.CRC32
import de.fraunhofer.isst.innamark.watermarker.utils.Compression
import de.fraunhofer.isst.innamark.watermarker.utils.fromBytesLittleEndian
import de.fraunhofer.isst.innamark.watermarker.utils.toBytesLittleEndian
import de.fraunhofer.isst.innamark.watermarker.utils.toHexString
        ...
        fun parse(input: ByteArray): Result<InnamarkTag> {
            ...
            val watermark =
                when (val tag = extractTag(input)) {
                    ...
                    CustomInnamarkTag.TYPE_TAG -> CustomInnamarkTag(input)
    ...
    override fun equals(other: Any?): Boolean {
        val equalClass =
            when (this) {
                ...
                is CustomInnamarkTag -> other is CustomInnamarkTag
            }
...
class CRC32InnamarkTag(
    ...
    override fun calculateChecksum(): Result<UInt> {
        ...
        return Result.success(calculateChecksum(checksumContent))
    }
}
...
class SHA3256InnamarkTag(
    ...
    override fun calculateHash(): Result<ByteArray> {
        ...
        return Result.success(calculateHash(hashInput))
    }
}
...
class CustomInnamarkTag(
    ...
    companion object {
        ...
        /** Creates a new `RawInnamarkTag` with containing [content] */
        @JvmStatic
        fun new(content: ByteArray): CustomInnamarkTag =
            CustomInnamarkTag(createRaw(TYPE_TAG, content))
