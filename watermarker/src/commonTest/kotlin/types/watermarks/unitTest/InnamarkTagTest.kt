...
class InnamarkTagTest {
    ...
    @Test
    fun sizedCRC32InnamarkTag_mismatchedSizeInvalidChecksum_warning() {
        // Arrange
    ...
    @Test
    fun sha3256InnamarkTag_invalidHash_warning() {
        // Arrange
    ...
    @Test
    fun sizedSHA3256InnamarkTag_mismatchedSizeInvalidHash_warning() {
        // Arrange
        val invalidSize =
            (
                InnamarkTagInterface.TAG_SIZE +
    ...
    fun parse_completeness_success() {
        ...
        val existingTags = listOf(0, 32, 16, 48, 8, 40, 64, 96, 80, 112, 72, 104, 128)
