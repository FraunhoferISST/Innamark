...
package watermarkers.file.unitTest
...
class TextFileWatermarkerTest {
    ...
    fun incompleteWatermarkWarning_string_success() {
        // Arrange
        val error = PlainTextWatermarker.IncompleteWatermarkWarning()
        val expected =
    ...
    fun oversizedWatermarkWarning_string_success() {
        // Arrange
        val error = PlainTextWatermarker.OversizedWatermarkWarning(10, 20)
        val expected =
            "Warning (PlainTextWatermarker.addWatermark): Could only insert 20 of 10 bytes from " +
                "the Watermark into the cover."
    ...
    fun containsAlphabetCharsError_string_success() {
        // Arrange
        val error = PlainTextWatermarker.ContainsAlphabetCharsError(sequenceOf('a', 'b'))
        val expected =
            "Error (PlainTextWatermarker.addWatermark): The input contains characters of the " +
                "watermark transcoding alphabet. It is only possible to add a watermark to an " +
    ...
    fun removeWatermarksGetProblemWarning_string_success() {
        // Arrange
        val error = PlainTextWatermarker.RemoveWatermarksGetProblemWarning()
        val expected =
            "Warning (PlainTextWatermarker.removeWatermarks): There was a problem extracting the " +
...
class TextFileWatermarkerBuilderTest {
    ...
    fun build_alphabetContainsSeparatorChar_error() {
        ...
        val error = PlainTextWatermarker.AlphabetContainsSeparatorError(listOf(alphabetChar))
    ...
    fun buildSecondStrategy_alphabetContainsSeparatorChar_error() {
        ...
        val errorEither =
            PlainTextWatermarker.AlphabetContainsSeparatorError(listOf(alphabetChar1))
        val errorBoth =
    ...
    fun alphabetContainsSeparatorCharError_string_success() {
        // Arrange
        val error = PlainTextWatermarker.AlphabetContainsSeparatorError(listOf('a'))
        val expected =
            "Error (PlainTextWatermarker): The alphabet contains separator char(s): ['\\u0061']"
