...
can be exchanged with another class implementing the interface. 
   - *Example*: class
   [`PlainTextWatermarker`](https://github.com/FraunhoferISST/Innamark/blob/92e8ba4334681b76f6df4f6e9b4f5ff41911c5af/watermarker/src/commonMain/kotlin/watermarkers/text/PlainTextWatermarker.kt)
